...
const ConfirmedVendor = () => {
  ...
  const handleDeleteAllClick = async () => {
    try {
      await fetch("http://localhost:4000/admin/vrequest/confirm/deleteAll", {
        method: "DELETE",
      });
  ...
  const getConfirmedVendors = async () => {
    try {
      const resp = await fetch("http://localhost:4000/admin/vrequest/confirm", {
        method: "GET",
      });
  ...
  const handleDeleteClick = async (id) => {
    try {
      await fetch(`http://localhost:4000/admin/vrequest/confirm`, {
        method: "DELETE",
        headers: {
